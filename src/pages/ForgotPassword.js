...
const handleSubmit = async (e) => {
  ...
  try 
  {
      const response = await axios.post('https://wikidialog.me/forgot-password', { email });
...
const handleCodeSubmit = async (e) => {
  ...
  setIsFetching2(true);
  try {
    const response = await axios.post('https://wikidialog.me/verify-reset-code', {
      email,
...
const handlePasswordChange = async (e) => {
  ...
  try {
    const response = await axios.post('https://wikidialog.me/change-password', { email: email, password: newPassword });
